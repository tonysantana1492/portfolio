...
export default function Loading() {
  return (
    <div className="mx-auto h-full max-h-screen w-full max-w-4xl overflow-hidden px-4">
      <div className="mb-4 flex items-center justify-between pt-26">
      ...
      <div className="space-y-3">
        {SKELETON_KEYS.slice(0, 20).map((key) => (
          <div
            key={key}
